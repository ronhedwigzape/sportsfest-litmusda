          ...
          <v-list>
            <v-list-item>
              <div class="v-navigator-drawer_content">
                <div class="v-sheet v-theme--light d-flex flex-column justify-center align-center align-center my-5 mx-3">
                  <div class="v-avatar v-theme v-avatar--dencitydefault v-avatar--variant-flat mb-3" style="width: 120px; height: 120px;">
