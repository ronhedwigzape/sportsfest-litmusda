            ...
            <form action="literary_operation.php" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" name="category_id" id="category_id" class="form-control" placeholder="Just select your Categories_ID number 3(literary)"  min="3" max="3" autocomplete="off" required>
                    </div>
...
<div class="container my-3">
    <div class="card">
        <div class="card-body">
            <h1 class="text-center"><b> <u>Literary</u> </b></h1>
