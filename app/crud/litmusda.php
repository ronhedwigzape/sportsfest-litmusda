    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Litmusda</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <form action="litmusda_operation.php" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Competition_ID</label>
                        <input type="number" min="2" max="2" name="competition_id" class="form-control" placeholder="Just select your Competition_ID number 2(litmusda)" autocomplete="off" required>
                    </div>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Litmusda</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <form action="litmusda_operation.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Competition_ID</label>
                        <input type="number" min="2" max="2" name="competition_id" id="competition_id" class="form-control" placeholder="Just select your Competition_ID number 2(litmusda)" autocomplete="off" required>
                    </div>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete Litmusda</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="container my-3">
    <div class="card">
        <div class="card-body">
            <h1 class="text-center"><b> <u>Litmusda</u> </b></h1>
            ...
            <?php
                ...
                $categories = Category::all($competition_ID);
            ?>
