...
<table class="table table-bordered" style="margin-top: 10px;">
    ...
    <tbody>
    <!-- Button trigger modal -->
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addDataTech<?=$techID?>" style="margin-left: 77%; width: 23%; margin-top: 30px;">
        Assign Event
    </button>

    <!-- ADD Modal -->
    <div class="modal fade" id="addDataTech<?=$techID?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <select class="form-select" aria-label="Default select example" style="width: 50%; color: white; background-color: #2F4F4F; text-align: center; margin-left: 25%;" id="selected_EventTech<?=$techID?>">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="closeAddTech<?=$techID?>">Close</button>
                    <button type="button" class="btn btn-primary" onclick="submitAddTech(<?=$techID?>)">Submit</button>
                </div>
            </div>
        </div>
    </div>
    <?php foreach ($techEvent as $eventData){ ?>
        <tr>
            ...
            <td style="width: 10%;">
                ...
                <img src="../dist/image/delete.png" type="button" width="20" height="20" style="cursor: pointer; margin-left: 10px;" data-bs-toggle="modal" data-bs-target="#deleteModal<?=$eventData->getId()?>">
            </td>
        </tr>
