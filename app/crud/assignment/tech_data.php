...
<body>
    ...
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addDataTech<?= $option ?>"
            style="margin-left: 77%; width: 23%; margin-top: 30px;">
        Assign Event
    </button>

    <!-- ADD Modal -->
    <div class="modal fade" id="addDataTech<?= $option ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" id="closeAddTech<?= $option ?>">
                        Close
                    </button>
    ...
    <table class="table table-bordered" style="margin-top: 10px;">
        ...
        <?php foreach($techEvent as $eventData) { ?>
            ...
            <!-- DELETE Modal -->
            <div class="modal fade" id="deleteTech<?= $eventData->getId() ?>" data-bs-backdrop="static"
