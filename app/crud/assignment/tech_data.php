    ...
    <?php foreach ($techEvent as $eventData){ ?>
        <tr>
            ...
            <td style="width: 10%;">
                ...
                <img src="image/delete.png" type="button" width="25" height="25" style="cursor: pointer; margin-left: 10px;" data-bs-toggle="modal" data-bs-target="#deleteTech<?=$eventData->getId()?>">
            </td>
        </tr>
