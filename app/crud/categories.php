                ...
                <div class="modal-body">
                    <?php
                        ...
                        foreach ($competitions as $competition) {
                            $competition_url = strtolower(str_replace(' ', '-', $competition->getSlug()));
                            if (strpos($page_url, $competition_url) !== false) {
                                $entity_category = $competition->getTitle();
                                break;
                            }
                        }
                    ?>
                    <div class="form-group">
                        ...
                        <select name="competition_id" class="form-control" required <?php if (!empty($entity_category)) echo 'disabled'; ?>>
                            ...
                            <?php foreach ($competitions as $competition) {
                                $selected = ($competition->getTitle() == $entity_category) ? 'selected' : '';
...
<!--                            <option value="">Select your Competition</option>-->
<!--                            <option value="1">Sports</option>-->
<!--                            <option value="2">Litmusda</option>-->
<!--                        </select>-->
<!--                    </div>-->
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="competition_id" id="competition_id" class="form-control" required>
                            <option value="">Select your Competition_ID</option>
                            <option value="1">Sports</option>
                            <option value="2">Litmusda</option>
                        </select>
                    </div>
