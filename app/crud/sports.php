...
<div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="sports_operation.php" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Competition_ID</label>
                        <input type="number" min="1" max="1" name="competition_id" class="form-control" placeholder="Just select the Competition_ID number 1(sports)" autocomplete="off" required>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="sports_operation.php" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Competition_ID</label>
                        <input type="number" min="1" max="1" name="competition_id" id="competition_id" class="form-control" placeholder="Just select the Competition_ID number 1(sports)" autocomplete="off" required>
                    </div>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete Sports</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="container my-3">
    <div class="card">
        <div class="card-body">
            <h1 class="text-center"><b> <u>Sports</u> </b></h1>
