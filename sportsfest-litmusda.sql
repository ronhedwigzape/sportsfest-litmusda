...
INSERT INTO `ratings` (`id`, `judge_id`, `team_id`, `criteria_id`, `value`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 0, '2023-02-21 06:10:47', '2023-02-21 06:10:47'),
(2, 1, 1, 2, 0, '2023-02-21 06:10:47', '2023-02-21 06:10:47'),
(3, 1, 1, 3, 0, '2023-02-21 06:10:47', '2023-02-21 06:10:47'),
(4, 1, 1, 4, 0, '2023-02-21 06:10:47', '2023-02-21 06:10:47'),
(5, 1, 2, 1, 0, '2023-02-21 06:12:39', '2023-02-21 06:12:39'),
(6, 1, 2, 2, 0, '2023-02-21 06:12:39', '2023-02-21 06:12:39'),
(7, 1, 2, 3, 0, '2023-02-21 06:13:30', '2023-02-21 06:13:30'),
(8, 1, 2, 4, 0, '2023-02-21 06:13:30', '2023-02-21 06:13:30'),
(9, 1, 3, 1, 0, '2023-02-21 06:14:53', '2023-02-21 06:14:53'),
(10, 1, 3, 2, 0, '2023-02-21 06:14:53', '2023-02-21 06:14:53'),
(11, 1, 3, 3, 0, '2023-02-21 06:14:53', '2023-02-21 06:14:53'),
(12, 1, 3, 4, 0, '2023-02-21 06:14:53', '2023-02-21 06:14:53'),
(13, 2, 1, 1, 0, '2023-02-21 06:17:33', '2023-02-21 06:19:35'),
(14, 2, 1, 2, 0, '2023-02-21 06:18:19', '2023-02-21 06:20:03'),
(15, 2, 1, 3, 0, '2023-02-21 06:21:48', '2023-02-21 06:21:48'),
(16, 2, 1, 4, 0, '2023-02-21 06:24:01', '2023-02-21 06:24:01'),
(17, 2, 2, 1, 0, '2023-02-21 06:25:53', '2023-02-21 06:25:53'),
(18, 2, 2, 2, 0, '2023-02-21 06:25:53', '2023-02-21 06:25:53'),
(19, 2, 2, 3, 0, '2023-02-21 06:26:43', '2023-02-21 06:26:43'),
(20, 2, 2, 4, 0, '2023-02-21 06:26:43', '2023-02-21 06:26:43'),
(21, 2, 3, 1, 0, '2023-02-21 06:28:38', '2023-02-21 06:30:20'),
(22, 2, 3, 2, 0, '2023-02-21 06:31:02', '2023-02-21 06:31:22'),
(23, 2, 3, 3, 0, '2023-02-21 06:43:59', '2023-02-21 06:44:58'),
(24, 2, 3, 4, 0, '2023-02-21 06:45:44', '2023-02-21 06:45:44');
...
--
ALTER TABLE `judge_categories`
  ADD CONSTRAINT `judge_categories_ibfk_1` FOREIGN KEY (`judge_id`) REFERENCES `judges` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Constraints for table `technical_categories`
--
ALTER TABLE `technical_categories`
  ADD CONSTRAINT `technical_categories_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `technical_categories_ibfk_2` FOREIGN KEY (`technical_id`) REFERENCES `technicals` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
